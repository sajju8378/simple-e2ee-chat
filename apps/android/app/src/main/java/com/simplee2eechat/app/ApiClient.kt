...
class ApiClient(private val baseUrl:String,private val token:String){
 ...
 companion object{
  ...
  fun register(base:String,username:String,name:String,password:String,publicKey:String):AuthResult=register(base,username,name,password,publicKey,Crypto.encryptPrivateKeyBackup("",password))
